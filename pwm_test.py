...
pin2_pwm=GPIO.PWM(pin2, 2)  #(pin, frequency)
pin3_pwm=GPIO.PWM(pin3, 2)  #(pin, frequency)
pin4_pwm=GPIO.PWM(pin4, 2)  #(pin, frequency)
pin5_pwm=GPIO.PWM(pin5, 2)  #(pin, frequency)
pin6_pwm=GPIO.PWM(pin6, 2)  #(pin, frequency)
